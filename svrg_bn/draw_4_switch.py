...
def main(num_epochs=NUM_EPOCHS):
	...
	if DRAW_COMPARE:
		...
		if LOAD_SGD: Line1_acc_test=			np.loadtxt(PATH_DATA +"Line1_acc_test.txt")
		if LOAD_SGD: Line1_acc_train=		np.loadtxt(PATH_DATA +"Line1_acc_train.txt")
		if LOAD_SGD: Line1_acc_val=			np.loadtxt(PATH_DATA +"Line1_acc_val.txt")
		if LOAD_SGD: Line1_loss_test=		np.loadtxt(PATH_DATA +"Line1_loss_test.txt")
		if LOAD_SGD: Line1_loss_train=		np.loadtxt(PATH_DATA +"Line1_loss_train.txt")
		if LOAD_SGD: Line1_loss_val=			np.loadtxt(PATH_DATA +"Line1_loss_val.txt")
		if LOAD_SGD: Line1_epoch_times=			np.loadtxt(PATH_DATA +"Line1_epoch_times.txt")

		if LOAD_SVRG: Line2_acc_train=		np.loadtxt(PATH_DATA_SVRG +"Line2_acc_train.txt")
		if LOAD_SVRG: Line2_acc_val=			np.loadtxt(PATH_DATA_SVRG +"Line2_acc_val.txt")
		if LOAD_SVRG: Line2_loss_train=		np.loadtxt(PATH_DATA_SVRG +"Line2_loss_train.txt")
		if LOAD_SVRG: Line2_loss_val=			np.loadtxt(PATH_DATA_SVRG +"Line2_loss_val.txt")
		if LOAD_SVRG: Line2_acc_test=			np.loadtxt(PATH_DATA_SVRG +"Line2_acc_test.txt")
		if LOAD_SVRG: Line2_loss_test=		np.loadtxt(PATH_DATA_SVRG +"Line2_loss_test.txt")
		if LOAD_SVRG: Line2_epoch_times=		np.loadtxt(PATH_DATA_SVRG +"Line2_epoch_times.txt")
		
		if LOAD_SVRG: Line3_acc_train=		np.loadtxt(PATH_DATA +"Line3_acc_train.txt")
		if LOAD_SVRG: Line3_acc_val=		np.loadtxt(PATH_DATA +"Line3_acc_val.txt")
		if LOAD_SVRG: Line3_loss_train=		np.loadtxt(PATH_DATA +"Line3_loss_train.txt")
		if LOAD_SVRG: Line3_loss_val=		np.loadtxt(PATH_DATA +"Line3_loss_val.txt")
		if LOAD_SVRG: Line3_acc_test=		np.loadtxt(PATH_DATA +"Line3_acc_test.txt")
		if LOAD_SVRG: Line3_loss_test=		np.loadtxt(PATH_DATA +"Line3_loss_test.txt")
		if LOAD_SVRG: Line3_epoch_times=		np.loadtxt(PATH_DATA +"Line3_epoch_times.txt")

		if LOAD_SVRG: Line4_acc_train=		np.loadtxt(PATH_DATA +"Line4_acc_train.txt")
		if LOAD_SVRG: Line4_acc_val=		np.loadtxt(PATH_DATA +"Line4_acc_val.txt")
		if LOAD_SVRG: Line4_loss_train=		np.loadtxt(PATH_DATA +"Line4_loss_train.txt")
		if LOAD_SVRG: Line4_loss_val=		np.loadtxt(PATH_DATA +"Line4_loss_val.txt")
		if LOAD_SVRG: Line4_acc_test=		np.loadtxt(PATH_DATA +"Line4_acc_test.txt")
		if LOAD_SVRG: Line4_loss_test=		np.loadtxt(PATH_DATA +"Line4_loss_test.txt")
		if LOAD_SVRG: Line4_epoch_times=		np.loadtxt(PATH_DATA +"Line4_epoch_times.txt")
