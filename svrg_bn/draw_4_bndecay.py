...
def main(num_epochs=NUM_EPOCHS):
	...
	if DRAW_COMPARE:
		...
		if DRAW_Line1: 	plt.plot(count_Line1, Line1_loss_val, SPEC_L1 ,label="Alpha = 0.25",  linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_loss_val, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(count_Line3, Line3_loss_val, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(count_Line4, Line4_loss_val, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(count_Line1, Line1_acc_val, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_acc_val, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(count_Line3, Line3_acc_val, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(count_Line4, Line4_acc_val, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(count_Line1, Line1_loss_train, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_loss_train, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(count_Line3, Line3_loss_train, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(count_Line4, Line4_loss_train, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(count_Line1, Line1_acc_train, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_acc_train, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(count_Line3, Line3_acc_train, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(count_Line4, Line4_acc_train, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: plt.plot(count_Line1, Line1_acc_test, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_acc_test, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3: 	plt.plot(count_Line3, Line3_acc_test, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4: 	plt.plot(count_Line4, Line4_acc_test, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
		...
		if DRAW_Line1: plt.plot(count_Line1, Line1_loss_test, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(count_Line2, Line2_loss_test, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3: 	plt.plot(count_Line3, Line3_loss_test, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4: 	plt.plot(count_Line4, Line4_loss_test, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(Line1_epoch_times, Line1_loss_val, SPEC_L1 ,label="Alpha = 0.25",  linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_loss_val, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(Line3_epoch_times, Line3_loss_val, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(Line4_epoch_times, Line4_loss_val, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(Line1_epoch_times, Line1_acc_val, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_acc_val, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(Line3_epoch_times, Line3_acc_val, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(Line4_epoch_times, Line4_acc_val, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(Line1_epoch_times, Line1_loss_train, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_loss_train, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(Line3_epoch_times, Line3_loss_train, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(Line4_epoch_times, Line4_loss_train, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
		...
		if DRAW_Line1: 	plt.plot(Line1_epoch_times, Line1_acc_train, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_acc_train, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3:	plt.plot(Line3_epoch_times, Line3_acc_train, SPEC_L3 ,label="Alpha = 0.75",  linewidth = LINEWIDTH)
		if DRAW_Line4:	plt.plot(Line4_epoch_times, Line4_acc_train, SPEC_L4 ,label="Alpha = 1.0",  linewidth = LINEWIDTH)
		...
		if DRAW_Line1: plt.plot(Line1_epoch_times, Line1_acc_test, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_acc_test, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3: 	plt.plot(Line3_epoch_times, Line3_acc_test, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4: 	plt.plot(Line4_epoch_times, Line4_acc_test, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
		...
		if DRAW_Line1: plt.plot(Line1_epoch_times, Line1_loss_test, SPEC_L1 ,label="Alpha = 0.25", linewidth = LINEWIDTH)
		if DRAW_Line2: 	plt.plot(Line2_epoch_times, Line2_loss_test, SPEC_L2 ,label="Alpha = 0.5",  linewidth = LINEWIDTH)
		if DRAW_Line3: 	plt.plot(Line3_epoch_times, Line3_loss_test, SPEC_L3 ,label="Alpha = 0.75", linewidth = LINEWIDTH)
		if DRAW_Line4: 	plt.plot(Line4_epoch_times, Line4_loss_test, SPEC_L4 ,label="Alpha = 1.0", linewidth = LINEWIDTH)
