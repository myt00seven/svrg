...
#!!!
        ...
        if PRINT[2] == 1:
            ...
            # plt.show()
            pylab.savefig(PATH_FIGURE+'CM_Validation_Accuracy'+'.png',bbox_inches='tight')
        ...
        if PRINT[3] == 1:
            ...
            plt.legend()
            # plt.show()
            pylab.savefig(PATH_FIGURE+'CM_Training_Set_Loss'+'.png',bbox_inches='tight')
        ...
        if PRINT[4] == 1:
            ...
            plt.legend(bbox_to_anchor=(1,0.4))
            # plt.show()
            pylab.savefig(PATH_FIGURE+'CM_Training_Set_Accuracy'+'.png',bbox_inches='tight')
...
#!!!
        ...
        if PRINT[6] == 1:
            ...
            plt.ylabel('Loss')
            plt.legend()
            pylab.savefig(PATH_FIGURE+'CM_Test_Loss'+'.png',bbox_inches='tight')
            # plt.show()
