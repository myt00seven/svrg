...
def main(model=MODEL,gradient = GRADIENT, num_epochs=NUM_EPOCHS):
    ...
    plt.legend()
    # plt.show()
    pylab.savefig('figure/'+'LossTrain-'+model+'-'+gradient+'-'+str(NUM_EPOCHS)+'.png',
       bbox_inches='tight')
    ...
    # plt.show()
    pylab.savefig('figure/'+'Pred-'+model+'-'+gradient+'-'+str(NUM_EPOCHS)+'.png',
       bbox_inches='tight')

    print ("Finish plotting...")

    np.savetxt("data/"+model+"_"+gradient+"_loss_train.txt",loss_train)
    np.savetxt("data/"+model+"_"+gradient+"_loss_val.txt",loss_val)
    np.savetxt("data/"+model+"_"+gradient+"_acc_train.txt",acc_train)
    np.savetxt("data/"+model+"_"+gradient+"_acc_val.txt",acc_val)
    print ("Data saved...")
